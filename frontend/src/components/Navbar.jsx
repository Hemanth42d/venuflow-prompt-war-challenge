...
export default function Navbar({ unreadAlerts = 0 }) {
  ...
  return (
    <nav className="glass border-b border-google-gray-200/60 sticky top-0 z-50" role="navigation" aria-label="Main navigation">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo + Status */}
          <div className="flex items-center gap-4">
            <NavLink to="/dashboard" className="flex items-center gap-2.5 group" aria-label="VenueFlow home">
          ...
          {/* Desktop nav */}
          <div className="hidden md:flex items-center gap-1 bg-google-gray-50 rounded-full p-1" role="menubar" aria-label="Primary navigation links">
      ...
      {/* Mobile nav */}
      {mobileOpen && (
        <div className="md:hidden border-t border-google-gray-200/60 bg-white px-4 py-3 space-y-1" role="menu" aria-label="Mobile navigation">
          {/* Mobile access badge */}
          {session && (
